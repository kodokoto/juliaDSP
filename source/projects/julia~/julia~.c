...
//void juliaDSP_perform64(t_juliaDSP *x, t_object *dsp64, double **ins, long numins, double **outs, long numouts, long sampleframes, long flags, void *userparam)
//{
//
...
////
////    // julia pointers to the left and right inputs
